...
def infer(opts: InferOpts) -> None:
    ...
    # print("Using dataset path: {}".format(datasets_path))
    ...
    print("bop_model_props: {}".format(bop_model_props))
    if object_lids is None:
        ...
        print("object_lids not specified, using all object_lids from bop_model_props: {}".format(object_lids))
    # print("opts.object_dataset: {}, object_lids: {}".format(opts.object_dataset, object_lids))
    ...
    # print("bop_test_split_props: {}".format(bop_test_split_props))
    ...
    for object_lid in object_lids:
        ...
        # for scene_id in scene_ids:
            ...
            for inst_j, instance in enumerate(instances):
                ...
                if image_np_hwc.ndim == 2:
                    image_np_hwc = np.stack([image_np_hwc] * 3, axis=-1)
